...
const ChartFilters = ({ onFiltersChange }) => {
  ...
  const handleTruthStatusChange = (truthStatus) => {
    const newFilters = { ...localFilters, truthStatus };
    setLocalFilters(newFilters);
    onFiltersChange(newFilters);
  };
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <select
                value={localFilters.truthStatus}
                onChange={(e) => handleTruthStatusChange(e.target.value)}
              ...
              >
                ...
                <option value="falsa">Solo falsas</option>
                <option value="verdadera">Solo verdaderas</option>
              </select>
