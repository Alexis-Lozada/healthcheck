    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm">
              Verificamos información de salud para combatir la desinformación y promover decisiones informadas.
            </p>
          </div>

          {/* Enlaces rápidos */}
          <div className="col-span-1">
            <h3 className="text-lg font-bold mb-4 text-blue-400">Enlaces Rápidos</h3>
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Inicio</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Cómo funciona</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Estadísticas</Link></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Términos de uso</Link></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span className="text-gray-400">contacto@healthcheck.com</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">&copy; 2025 HealthCheck - Todos los derechos reservados</p>
        </div>
      </div>
    </footer>
  );
